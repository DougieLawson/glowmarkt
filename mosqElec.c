...
enum {unk, unused, elec_multiplier, elec_divisor, elec_consumption, ts, };
...
int lexer(const char *s)
{
	...
	token_table[] = {
	       	...
	       	{"ets", unused},
	       	{"gasMtr07020000", unused},
	       	{"gasMtr07020014", unused},
	       	{"gasMtr07020200", unused},
	       	{"gasMtr07020300", unused},
	       	{"gasMtr07020301", unused},
	       	{"gasMtr07020302", unused},
	       	{"gasMtr07020303", unused},
	       	{"gasMtr07020306", unused},
	       	{"gasMtr07020307", unused},
	       	{"gasMtr07020308", unused},
	       	{"gasMtr07020312", unused},
	       	{"gasMtr07020C01", unused},
	       	{"gasMtr07020C30", unused},
	       	{"gasMtr07020C40", unused},
...
void glow_message(struct mosquitto *mosq, void *obj, const struct mosquitto_message *message)
{
	...
	const char* topic = "meterReading/out/elec";
	nesting = 0;
	...
	sprintf(localMQTTmessage, "{\"Meter\": %.3f, \"Timestamp\": \"%s\"}" , elecConsumption, time_stamp);
